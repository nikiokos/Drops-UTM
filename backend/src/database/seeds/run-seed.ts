...
async function runSeed() {
  ...
  if (!org) {
    org = orgRepo.create({
      ...
      type: 'operator',
      registrationNumber: 'OP-2025-KR-001',
      contactInfo: { email: 'ops@drops-aero.com', phone: '+82-2-555-0100' },
      address: { city: 'Seoul', country: 'South Korea', street: '221 Teheran-ro, Gangnam-gu' },
      status: 'active',
    });
  ...
  const usersData = [
    { email: 'admin@drops-utm.com', firstName: 'Alex', lastName: 'Kim', role: 'admin' },
    { email: 'pilot@drops-utm.com', firstName: 'Jihye', lastName: 'Park', role: 'pilot' },
    { email: 'operator@drops-utm.com', firstName: 'Minho', lastName: 'Lee', role: 'hub_operator' },
  ];
  ...
  const hubsData = [
    ...
    {
      code: 'GNG-HUB',
      name: 'Gangnam Operations Center',
    ...
    {
      code: 'YIS-HUB',
      name: 'Yeouido Sky Port',
      location: { latitude: 37.5219, longitude: 126.9245 },
      airspaceRadius: 6000,
      airspaceCeiling: 350,
      airspaceFloor: 0,
      timezone: 'Asia/Seoul',
    ...
    {
      code: 'SWN-HUB',
      name: 'Suwon Test Facility',
      location: { latitude: 37.2636, longitude: 127.0286 },
      airspaceRadius: 10000,
      airspaceCeiling: 500,
      airspaceFloor: 0,
      timezone: 'Asia/Seoul',
      status: 'maintenance',
  ...
  const flightsData = [
    {
      ...
      authorizationNumber: 'AUTH-ICN-001',
      missionType: 'cargo',
      payloadWeight: 3.5,
      riskAssessment: 'low',
      notes: 'Medical supplies delivery — priority route',
    },
    {
      ...
      notes: 'Bridge inspection along Han River corridor',
    },
    {
      ...
      minAltitude: 60,
      authorizationStatus: 'approved',
      authorizationNumber: 'AUTH-GNG-002',
      missionType: 'cargo',
      payloadWeight: 5.0,
      riskAssessment: 'low',
    },
    {
      ...
      minAltitude: 90,
      authorizationStatus: 'approved',
      authorizationNumber: 'AUTH-YIS-003',
      missionType: 'cargo',
      payloadWeight: 12.0,
      riskAssessment: 'low',
      notes: 'Heavy cargo — construction materials',
    },
    {
      ...
      minAltitude: 50,
      authorizationStatus: 'approved',
      authorizationNumber: 'AUTH-YIS-004',
    ...
    },
    {
      ...
      riskAssessment: 'low',
      notes: 'Coastal perimeter monitoring — Jeju',
    },
    {
      ...
      minAltitude: 100,
      authorizationStatus: 'approved',
      authorizationNumber: 'AUTH-JEJ-005',
      missionType: 'medical',
      payloadWeight: 1.2,
      riskAssessment: 'low',
      notes: 'Blood sample delivery to rural clinic',
    },
    {
      ...
      authorizationStatus: 'approved',
      authorizationNumber: 'AUTH-ICN-006',
  ...
  const zonesData = [
    {
      name: 'Incheon Airport CTR',
      zoneType: 'controlled',
      hubId: hubs[0].id,
      geometry: {
        coordinates: [
          { latitude: 37.47, longitude: 126.43 },
          { latitude: 37.47, longitude: 126.46 },
          { latitude: 37.45, longitude: 126.46 },
          { latitude: 37.45, longitude: 126.43 },
        ],
      },
      altitudeFloor: 0,
      altitudeCeiling: 400,
    ...
    {
      name: 'Han River Corridor',
      zoneType: 'corridor',
      geometry: {
        coordinates: [
          { latitude: 37.528, longitude: 126.90 },
          { latitude: 37.528, longitude: 127.05 },
          { latitude: 37.518, longitude: 127.05 },
          { latitude: 37.518, longitude: 126.90 },
        ],
      },
      altitudeFloor: 50,
      altitudeCeiling: 300,
    ...
    {
      name: 'Blue House No-Fly Zone',
      zoneType: 'prohibited',
      geometry: {
        coordinates: [
          { latitude: 37.588, longitude: 126.972 },
          { latitude: 37.588, longitude: 126.980 },
          { latitude: 37.582, longitude: 126.980 },
          { latitude: 37.582, longitude: 126.972 },
        ],
      },
      altitudeFloor: 0,
      altitudeCeiling: 600,
    ...
    {
      name: 'Suwon Test Range',
      zoneType: 'warning',
      hubId: hubs[3].id,
      geometry: {
        coordinates: [
          { latitude: 37.27, longitude: 127.02 },
          { latitude: 37.27, longitude: 127.04 },
          { latitude: 37.25, longitude: 127.04 },
          { latitude: 37.25, longitude: 127.02 },
        ],
      },
      altitudeFloor: 0,
      altitudeCeiling: 500,
  ...
  const conflictsData = [
    {
      ...
      hubId: hubs[1].id,
      description: 'Minimum separation breach detected between DRP-2025-0001 and DRP-2025-0003 near Gangnam Operations Center. Projected convergence at 250m altitude.',
      separationDistance: 180,
      location: { latitude: 37.498, longitude: 127.025 },
      altitude: 250,
    ...
    },
    {
      ...
      primaryFlightId: flights[0].id,
      hubId: hubs[1].id,
      description: 'Flight DRP-2025-0001 trajectory enters Gangnam Restricted Zone boundary. Rerouting recommended.',
      location: { latitude: 37.497, longitude: 127.030 },
      altitude: 140,
      detectionMethod: 'geofence',
      resolutionStrategy: 'Route deviation via corridor GNG-ALT-1',
    },
    {
  ...
  const incidentsData: Partial<EmergencyIncident>[] = [
    ...
    },
    {
      ...
      severity: 'warning',
      status: 'resolved',
      message: 'Approaching Gangnam Restricted Zone boundary - 50m margin',
      ...
      resolutionNotes: 'Flight path adjusted to maintain safe margin from restricted zone',
      rootCause: 'software',

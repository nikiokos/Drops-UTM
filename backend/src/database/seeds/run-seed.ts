...
async function runSeed() {
  ...
  const flightsData = [
    ...
    },
    {
      ...
      status: 'active',
      plannedDeparture: hoursAgo(0.6),
      plannedArrival: hoursFromNow(1.4),
      actualDeparture: hoursAgo(0.5),
      maxAltitude: 300,
      minAltitude: 100,
      authorizationStatus: 'approved',
      authorizationNumber: 'AUTH-ATH-007',
    ...
    },
    {
      ...
      operationMode: 'autonomous',
      status: 'active',
      plannedDeparture: hoursAgo(0.4),
      plannedArrival: hoursFromNow(0.6),
      actualDeparture: hoursAgo(0.3),
      maxAltitude: 200,
      minAltitude: 60,
      authorizationStatus: 'approved',
